        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title"><?= $Lang->get('SHOP__ADMIN_MANAGE_PAYMENT') ?></h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="tab_nano">

                                <h3><?= $Lang->get('SHOP__NANO_OFFERS') ?> <a
                                            href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'add_nano', 'admin' => true)) ?>"
                                            class="btn btn-success pull-right"><?= $Lang->get('GLOBAL__ADD') ?></a></h3>

                                <br>
                                <div class="alert alert-info">
                                    <p>
                                        <?= $Lang->get('SHOP__NANO_EXPLAIN_CONFIG_1') ?><a target="_blank"
                                                                                           href="https://app.brainblocks.io"><b>Brainblocks</b></a><?= $Lang->get('SHOP__NANO_EXPLAIN_CONFIG_2') ?>
                                        <a target="_blank" href="https://natrium.io"><b>Natrium</b></a>
                                    </p>
                                    <p><?= $Lang->get('SHOP__NANO_EXPLAIN_CONFIG_3') ?><a target="_blank"
                                                                                          href="https://www.youtube.com/watch?v=ydVomoXEGe0"><b>YouTube
                                                (English)</b></a></p>
                                    <span><?= $Lang->get('SHOP__NANO_EXPLAIN_CONFIG_4') ?><a target="_blank"
                                                                                             href="https://www.nano.org/"><b>Nano.org</b></a>
                                    </span>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'edit_nano/' . $value["Nano"]["id"], 'admin' => true)) ?>"
                                                           class="btn btn-info"><?= $Lang->get('GLOBAL__EDIT') ?></a>
                                                        <a onClick="confirmDel('<?= $this->Html->url(array('controller' => 'shop', 'action' => 'delete/nano/' . $value["Nano"]["id"], 'admin' => true)) ?>')"
                            ...
                            <div class="tab-pane fade" id="tab_starpass">

                                <h3><?= $Lang->get('SHOP__STARPASS_OFFERS') ?> <a
                                            href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'add_starpass', 'admin' => true)) ?>"
                                            class="btn btn-success pull-right"><?= $Lang->get('GLOBAL__ADD') ?></a></h3>
                                    ...
                                    <?php if (isset($offers['starpass'])) { ?>
                                        <?php foreach ($offers['starpass'] as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'edit_starpass/' . $value["Starpass"]["id"], 'admin' => true)) ?>"
                                                           class="btn btn-info"><?= $Lang->get('GLOBAL__EDIT') ?></a>
                                                        <a onClick="confirmDel('<?= $this->Html->url(array('controller' => 'shop', 'action' => 'delete/starpass/' . $value["Starpass"]["id"], 'admin' => true)) ?>')"
                                                           class="btn btn-danger"><?= $Lang->get('GLOBAL__DELETE') ?></a>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="tab-pane fade" id="tab_paypal">

                                <h3><?= $Lang->get('SHOP__PAYPAL_OFFERS') ?> <a
                                            href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'add_paypal', 'admin' => true)) ?>"
                                            class="btn btn-success pull-right"><?= $Lang->get('GLOBAL__ADD') ?></a></h3>
                                    ...
                                    <?php if (isset($offers['paypal'])) { ?>
                                        <?php foreach ($offers['paypal'] as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group">
                                                        <a href="<?= $this->Html->url(array('controller' => 'payment', 'action' => 'edit_paypal/' . $value["Paypal"]["id"], 'admin' => true)) ?>"
                                                           class="btn btn-info"><?= $Lang->get('GLOBAL__EDIT') ?></a>
                                                        <a onClick="confirmDel('<?= $this->Html->url(array('controller' => 'shop', 'action' => 'delete/paypal/' . $value["Paypal"]["id"], 'admin' => true)) ?>')"
                                                           class="btn btn-danger"><?= $Lang->get('GLOBAL__DELETE') ?></a>
                                                    </div>
                                                </td>
                                            </tr>
                            ...
                            <div class="tab-pane fade" id="tab_psc">

                                <h3><?= $Lang->get('SHOP__PAYSAFECARD_ADMIN_TITLE') ?> <a
                                            href="<?= $this->Html->url(array('action' => 'toggle_paysafecard')) ?>"
                                            class="btn btn-<?= ($paysafecardsStatus) ? 'danger' : 'success' ?> pull-right"><?= ($paysafecardsStatus) ? $Lang->get('GLOBAL__DISABLE') : $Lang->get('GLOBAL__ENABLE') ?></a>
                                </h3>
                                        ...
                                        <?php foreach ($paysafecards as $key => $value) { ?>
                                            <?php if ($value['Paysafecard']['user_id'] != "0") { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                           onClick="howmuch(<?= $value['Paysafecard']['id'] ?>)"
                                                           class="btn btn-success"><?= $Lang->get('SHOP__PAYSAFECARD_ACCEPT') ?></a>
                                                        <a href="<?= $this->Html->url(array('action' => 'paysafecard_invalid/' . $value['Paysafecard']['id'])) ?>"
                                                           class="btn btn-danger"><?= $Lang->get('SHOP__PAYSAFECARD_REFUSE') ?></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        <?php } ?>
                            ...
                            <div class="tab-pane fade" id="tab_dedipass">

                                <h3><?= $Lang->get('SHOP__DEDIPASS_CONFIGURATION') ?> <a
                                            href="<?= $this->Html->url(array('action' => 'toggle_dedipass')) ?>"
                                            class="btn btn-<?= (isset($dedipassConfig['DedipassConfig']['status']) && $dedipassConfig['DedipassConfig']['status']) ? 'danger' : 'success' ?> pull-right"><?= (isset($dedipassConfig['DedipassConfig']['status']) && $dedipassConfig['DedipassConfig']['status']) ? $Lang->get('GLOBAL__DISABLE') : $Lang->get('GLOBAL__ENABLE') ?></a>
                                </h3>
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <p><b><?= $Lang->get('SHOP__DEDIPASS_EXPLAIN_CONFIG_URL_1') ?>
                                            :</b> <?= $this->Html->url('/shop/payment/dedipass', true) ?></p>
                                    <p><b><?= $Lang->get('SHOP__DEDIPASS_EXPLAIN_CONFIG_URL_2') ?>
                                            :</b> <?= $this->Html->url('/shop/payment/dedipass_ipn', true) ?></p>
                                </div>

                                <form action="<?= $this->Html->url(array('action' => 'dedipass_config')) ?>"
                                      data-ajax="true">

                                    <div class="form-group">
                                        <label><?= $Lang->get('SHOP__DEDIPASS_PUBLICKEY') ?></label>
                                        <input type="text" class="form-control" name="publicKey"
                                               placeholder="Ex: 4e2009e88d5c5587302e996de5fe1f47"<?= (isset($dedipassConfig['DedipassConfig']['public_key'])) ? ' value="' . $dedipassConfig['DedipassConfig']['public_key'] . '"' : '' ?>>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="tab_points_transfer">

                                <h3>
                                    <?= $Lang->get('SHOP__USER_POINTS_TRANSFER_HISTORIES', array('{MONEY_NAME}' => $Configuration->getMoneyName())) ?>
                                    <a href="<?= $this->Html->url(array('action' => 'toggle_transfer')) ?>"
                                       class="btn btn-<?= ($transferStatus) ? 'danger' : 'success' ?> pull-right"><?= ($transferStatus) ? $Lang->get('GLOBAL__DISABLE') : $Lang->get('GLOBAL__ENABLE') ?></a>
                                </h3>
