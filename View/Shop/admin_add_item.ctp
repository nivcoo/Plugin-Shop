            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= $this->Html->url(array('controller' => 'shop', 'action' => 'add_item_ajax')) ?>"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="category">
                                <?php foreach ($search_categories as $v) { ?>
                                    <option <?= ($category_id == $v['Category']['id']) ? "selected" : "" ?>
                                            value="<?= $v['Category']['id'] ?>">
                        ...
                        <div class="form-group">
                            <div class="checkbox">
                                <input name="reductional_items_checkbox" id="reductional_items_checkbox"
                                       type="checkbox">
                        ...
                        <div class="form-group">
                            ...
                            <input name="buy_limit" class="form-control" type="text" value="0"
