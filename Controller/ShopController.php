    ...
    public function admin_edit_ajax() {
      ...
      if($this->isConnected AND $this->Permissions->can('SHOP__ADMIN_MANAGE_ITEMS')) {
        if($this->request->is('post')) {
          ...
          if(!empty($this->request->data['id']) AND !empty($this->request->data['name']) AND !empty($this->request->data['description']) AND !empty($this->request->data['category']) AND (!empty($this->request->data['price']) || $this->request->data['price'] == 0) AND !empty($this->request->data['servers']) AND !empty($this->request->data['commands']) AND !empty($this->request->data['timedCommand'])) {
            $this->loadModel('Shop.Category');
    ...
    public function admin_add_item_ajax() {
      ...
      if($this->isConnected AND $this->Permissions->can('SHOP__ADMIN_MANAGE_ITEMS')) {
        if($this->request->is('post')) {
          ...
          if(!empty($this->request->data['name']) AND !empty($this->request->data['description']) AND !empty($this->request->data['category']) AND (!empty($this->request->data['price']) || $this->request->data['price'] == 0) AND !empty($this->request->data['servers']) AND !empty($this->request->data['commands']) AND !empty($this->request->data['timedCommand'])) {
            $this->loadModel('Shop.Category');
            $this->request->data['category'] = $this->Category->find('all', array('conditions' => array('name' => $this->request->data['category'])));
            $this->request->data['category'] = $this->request->data['category'][0]['Category']['id'];
            $this->request->data['timedCommand'] = ($this->request->data['timedCommand'] == 'true') ? 1 : 0;
